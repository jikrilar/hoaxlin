...
Snapshot knowledge base v1.0.0 memuat 24 dokumen dan evaluation v1.0.0 memuat 20 query dengan relevance judgment yang disetujui owner untuk corpus tersebut. Evaluasi baseline R11 melaporkan Hit Rate@3/@5 1.0, Precision@3 0.4, Precision@5 0.25, Recall@3 0.975, Recall@5 1.0, dan MRR 0.95. Artifact terpisah R14 mengevaluasi corpus runtime v1.1.1 (61 dokumen) dengan 20 query yang sama: Hit Rate@3/@5 1.0, Precision@3 0.383333, Precision@5 0.25, Recall@3 0.958333, Recall@5 1.0, dan MRR 0.95. Approval relevance tetap untuk v1.0.0; dokumen tambahan v1.1.1 belum memiliki judgment independen, sehingga hasil R14 terbatas dan metrik precision dapat dipengaruhi label yang belum lengkap. Perbedaan lintas corpus bersifat deskriptif, bukan klaim peningkatan/penurunan absolut. Threshold sweep eksploratif tidak menetapkan nilai production; `RAG_MIN_SCORE` tetap kosong. Untuk menjalankan service lokal, siapkan revision model embedding yang dipatok terlebih dahulu dengan `python -m app.prepare_model`; langkah ini memerlukan jaringan satu kali. Perilaku saat knowledge base kosong tetap diuji menggunakan fixture sementara, bukan corpus production.
